...
class BookMyShowProfile extends StatefulWidget {
  const BookMyShowProfile({super.key});

  @override
  State<BookMyShowProfile> createState() => _BookMyShowProfileState();
}

class _BookMyShowProfileState extends State<BookMyShowProfile> {
  var listContent = [
